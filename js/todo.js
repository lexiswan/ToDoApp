var ToDo = function (rootElementAll, rootElementActive, rootElementCompleted) {
    ...
    //obiecte care reprezinta elemnte in cadrul aplicatiei todo
...
`;
    ...
    function generateToDoItemView(toDoItem) {
        ...
        //in interiorul acestui div impachetam sablonul creat
        ...
        //inserarea datelor in elemenetele corespunzatoare
        ...
        //se verifica daca elementul este completat
        toDoItemRoot.classList.add(toDoItem.completed ? "completed" : null);

        //obtinem o copie identica a obiectului DOM creat
        //clonam fiindca fiecare element adaugat se va gasi in 2 liste 
